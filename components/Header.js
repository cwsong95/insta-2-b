...
function Header() {
  ...
  console.log(session);
  return (
    <div className='shadow-sm bonrder-b bg-white sticky top-0 z-50'>
          ...
          {session ? (
            <>
              <div className='relative navBtn'>
                ...
                <div className='absolute -top-1 -right-2 text-xs w-5 h-5 bg-red-500 rounded-full justify-center animate-pulse text-white flex items-center'>3</div>
              </div>
              <PlusCircleIcon
              ...
              <img onClick={signOut} src={session?.user?.image} alt="profile pic" className='h-10 w-10 2-10 rounded-full cursor-pointer'/>
            </>
          ): (
